...
- 자금관리(/fund 페이지): get_fund_summary / get_project_detail / compare_projects / generate_project_report / update_project_info / add_project_note / add_project_subcontract / update_collection_status / add_project_todo / add_project_contact / get_overdue_items / update_project_milestone
